// Data/Location/locationHeroData.js

export const locationHeroData = {
  boroughbridge: {
    breadcrumb: ["Home", "Locations", "Boroughbridge"],
  ...
  harrogate: {
    breadcrumb: ["Home", "Locations", "Harrogate"],
    region: "North Yorkshire",
    city: "Harrogate",
    description:
  ...
  thirsk: {
    breadcrumb: ["Home", "Locations", "Thirsk"],
    region: "North Yorkshire",
    city: "Thirsk",
    description:
  ...
  leeds: {
    breadcrumb: ["Home", "Locations", "Leeds"],
  ...
  garforth: {
    breadcrumb: ["Home", "Locations", "Garforth"],
    region: "West Yorkshire",
    city: "Garforth",
    description:
  ...
  wakefield: {
    breadcrumb: ["Home", "Locations", "Wakefield"],
    region: "West Yorkshire",
    city: "Wakefield",
    description:
